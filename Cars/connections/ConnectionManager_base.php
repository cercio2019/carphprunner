...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "Cars_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["carscars"] = "Cars_at_localhost";
		$connectionsIds["carsmake"] = "Cars_at_localhost";
		$connectionsIds["carsmodels"] = "Cars_at_localhost";
		$connectionsIds["carsbcolor"] = "Cars_at_localhost";
		$connectionsIds["carscategory"] = "Cars_at_localhost";
		$connectionsIds["carsform"] = "Cars_at_localhost";
		$connectionsIds["public.carsusers"] = "Cars_at_localhost";
		$connectionsIds["public.carsmodels"] = "Cars_at_localhost";
		$connectionsIds["public.carsmake"] = "Cars_at_localhost";
		$connectionsIds["public.carsform"] = "Cars_at_localhost";
		$connectionsIds["public.carscars"] = "Cars_at_localhost";
		$connectionsIds["public.carsbcolor"] = "Cars_at_localhost";
		$connectionsIds["public.carscategory"] = "Cars_at_localhost";
