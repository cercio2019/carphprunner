...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "Cars_at_localhost";
		$data["connName"] = "Cars at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;postgres;1495;;cars;;1;"; //currently unused

		$this->_connectionsIdByName["Cars at localhost"] = "Cars_at_localhost";
		...
		$data["connInfo"][2] = "1495";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "cars";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "Driver={PostgreSQL Unicode};Server=localhost;Database=cars;Uid=postgres;Pwd=1495";
		// encription set
		...
		$connectionsData["Cars_at_localhost"] = $data;
