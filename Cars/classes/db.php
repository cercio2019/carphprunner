...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "Cars_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "carsbcolor", "varname" => "Cars_at_localhost_public_carsbcolor", "altvarname" => "carsbcolor", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carscars", "varname" => "Cars_at_localhost_public_carscars", "altvarname" => "carscars", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carscategory", "varname" => "Cars_at_localhost_public_carscategory", "altvarname" => "carscategory", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsform", "varname" => "Cars_at_localhost_public_carsform", "altvarname" => "carsform", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsmake", "varname" => "Cars_at_localhost_public_carsmake", "altvarname" => "carsmake", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsmodels", "varname" => "Cars_at_localhost_public_carsmodels", "altvarname" => "carsmodels", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
			$dalTables[$conn->connId][] = array("name" => "carsusers", "varname" => "Cars_at_localhost_public_carsusers", "altvarname" => "carsusers", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		}
	}
