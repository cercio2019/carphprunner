...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("public.carscars" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsmake" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsmodels" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsbcolor" == $this->chrt_array['tables'][0])
			return true;
		if("public.carscategory" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsform" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsusers" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsmodels" == $this->chrt_array['tables'][0])
			return true;
		if("public.carsmake" == $this->chrt_array['tables'][0])
