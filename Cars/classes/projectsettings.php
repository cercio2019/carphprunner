	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("public.carsusers", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "carscars" ] = array( "url" => "carscars", "type" => 1 );
	$projectEntitiesReverse[ "carscars" ] = "carscars";
	$projectEntities[ "carsmake" ] = array( "url" => "carsmake", "type" => 1 );
	$projectEntitiesReverse[ "carsmake" ] = "carsmake";
	$projectEntities[ "carsmodels" ] = array( "url" => "carsmodels", "type" => 1 );
	$projectEntitiesReverse[ "carsmodels" ] = "carsmodels";
	$projectEntities[ "carsbcolor" ] = array( "url" => "carsbcolor", "type" => 1 );
	$projectEntitiesReverse[ "carsbcolor" ] = "carsbcolor";
	$projectEntities[ "carscategory" ] = array( "url" => "carscategory", "type" => 1 );
	$projectEntitiesReverse[ "carscategory" ] = "carscategory";
	$projectEntities[ "carsform" ] = array( "url" => "carsform", "type" => 1 );
	$projectEntitiesReverse[ "carsform" ] = "carsform";
	$projectEntities[ "public.carsusers" ] = array( "url" => "public_carsusers", "type" => 0 );
	$projectEntitiesReverse[ "public_carsusers" ] = "public.carsusers";
	$projectEntities[ "public.carsmodels" ] = array( "url" => "carsmodels1", "type" => 0 );
	$projectEntitiesReverse[ "carsmodels1" ] = "public.carsmodels";
	$projectEntities[ "public.carsmake" ] = array( "url" => "carsmake1", "type" => 0 );
	$projectEntitiesReverse[ "carsmake1" ] = "public.carsmake";
	$projectEntities[ "public.carsform" ] = array( "url" => "carsform1", "type" => 0 );
	$projectEntitiesReverse[ "carsform1" ] = "public.carsform";
	$projectEntities[ "public.carscars" ] = array( "url" => "carscars1", "type" => 0 );
	$projectEntitiesReverse[ "carscars1" ] = "public.carscars";
	$projectEntities[ "public.carsbcolor" ] = array( "url" => "carsbcolor1", "type" => 0 );
	$projectEntitiesReverse[ "carsbcolor1" ] = "public.carsbcolor";
	$projectEntities[ "public.carscategory" ] = array( "url" => "carscategory1", "type" => 0 );
	$projectEntitiesReverse[ "carscategory1" ] = "public.carscategory";
}
