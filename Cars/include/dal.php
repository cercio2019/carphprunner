...
class tDAL
{
	var $tblCars_at_localhost_public_carsbcolor;
	var $tblCars_at_localhost_public_carscars;
	var $tblCars_at_localhost_public_carscategory;
	var $tblCars_at_localhost_public_carsform;
	var $tblCars_at_localhost_public_carsmake;
	var $tblCars_at_localhost_public_carsmodels;
	var $tblCars_at_localhost_public_carsusers;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "carsbcolor", "varname" => "Cars_at_localhost_public_carsbcolor", "altvarname" => "carsbcolor", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carscars", "varname" => "Cars_at_localhost_public_carscars", "altvarname" => "carscars", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carscategory", "varname" => "Cars_at_localhost_public_carscategory", "altvarname" => "carscategory", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsform", "varname" => "Cars_at_localhost_public_carsform", "altvarname" => "carsform", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsmake", "varname" => "Cars_at_localhost_public_carsmake", "altvarname" => "carsmake", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsmodels", "varname" => "Cars_at_localhost_public_carsmodels", "altvarname" => "carsmodels", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
		$this->lstTables[] = array("name" => "carsusers", "varname" => "Cars_at_localhost_public_carsusers", "altvarname" => "carsusers", "connId" => "Cars_at_localhost", "schema" => "public", "connName" => "Cars at localhost");
	}
