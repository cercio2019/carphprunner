...
if($buttId=='New_Button_back')
{
	...
	buttonHandler_New_Button_back($params);
}
if($buttId=='Get_a_quote')
{
	//  for login page users table can be turned off
	if( $table != GLOBAL_PAGES )
	{
	...
	buttonHandler_Get_a_quote($params);
}


if( $eventId == 'carscars_click_row' && "carscars" == $table )
{
	require_once("include/carscars_variables.php");
	$cipherer = new RunnerCipherer("carscars");
	ajaxHandler_carscars_click_row($params);
	return;
}
...
function buttonHandler_New_Button_back($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_Get_a_quote($params)
{
	global $strTableName;
	$result = array();
...
function ajaxHandler_carscars_click_row($params)
{
	global $strTableName;
	$result = array();
